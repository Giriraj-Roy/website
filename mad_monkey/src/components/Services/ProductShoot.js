...
import img from '../../assets/Services/Group (4).png'
...
const ProductShoot = () => {
  return (
    <div className='my-32 block md:flex font-gilroy text-justify'>
      ...
      <div className='mx-16 md:mx-0 md:ml-16 py-8 md:py-0 w-[70%] md:w-3/5 bg-[#007BFF] rounded-3xl md:rounded-l-[3rem] md:rounded-r-none'>
