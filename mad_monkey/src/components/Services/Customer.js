...
import img from '../../assets/Services/Group.png'
...
const Customer = () => {
  return (
    <div className='my-32 block md:flex font-gilroy text-justify'>
      ...
      <div className='mx-16 md:mx-0 md:ml-16 py-8 md:py-0 w-[70%] md:w-3/5 bg-[#FF6E1A] rounded-3xl md:rounded-l-[3rem] md:rounded-r-none'>
        <div className='mx-6 md:mx-16 my-16 bg-transparent text-white text-4xl font-[700] '>
          Customer Review Management
        </div>
        <div className='hidden md:block mx-16 bg-transparent text-white text-2xl font-[500] '>
