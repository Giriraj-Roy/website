...
const Whyus = () => {
    return (
        <div>
            ...
            <br/>
            <div className='font-gilroy text-[#FFFFFF] text-3xl md:text-5xl font-semibold w-9/10 md:w-1/2 '>
                We belief in customized approach
            </div>
            <br/>
            <br/>
            <div className='block md:flex w-full'>
                <div className='bg-[#E63946] w-[75%] md:w-[30%] aspect-[3/1] md:aspect-[4/3] mb-10 md:mb-0 mr-10 md:mr-10 p-5 rounded-xl text-white '>
                        <img
